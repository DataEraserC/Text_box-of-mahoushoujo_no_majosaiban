...
- 🎨 背景选择 - 支持16种不同背景选择
- ⚙️ 高度可配置 - 角色、背景、文本框位置等均可通过配置文件自定义
...
{
  "text_box": {
    "position": [728, 355],  // 文本框左上角坐标
    "over": [2339, 800]      // 文本框右下角坐标
  },
  "default_character": "sherri"  // 默认角色ID
}
```
...
[
  {
    "id": "ema",           // 角色ID
    "name": "樱羽艾玛",     // 角色名称
    "emotion_count": 8,    // 表情数量
    "font": "font3.ttf"    // 使用的字体文件
  }
]
```
