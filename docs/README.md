...
1. **Python版本** - 原始版本，基于本地快捷键操作
2. **Go Web版本** - 新版本，基于Web界面操作
...
1. 运行Go服务: `go run main.go`
2. 打开浏览器访问: http://localhost:8080/frontend/
3. 选择角色、表情、背景
4. 输入文本内容
5. 点击生成图片按钮
6. 预览并下载生成的图片
...
详细API接口文档请参考 [docs/api_design.md](api_design.md) 文件
...
## Python版本更新日志（学长说最好写个这东西，虽然没写过但是先养成习惯？）
